    ...
    <main className="mx-auto max-w-3xl px-4 py-8">
      ...
      >
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-full bg-zinc-900 px-4 py-2 text-xs font-medium text-white hover:bg-zinc-800 disabled:opacity-50"
        >
          {t("ops.staff.grant")}
        </button>
      </form>
